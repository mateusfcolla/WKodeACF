        ...
        foreach($slider as $slide){
          if(!empty($slide['slider_image'])){
            ...
            <div class="wkode-slider-slide">
              <img src="<?php echo $slide['slider_image']['sizes']['slider']; ?>" alt="Imagem de slider <?php echo $slide['slider_image']['title']; ?>" srcset="">
            </div>
            <?php
          }else{?>
            <div class="wkode-slider-slide" style="background-color: black;">
              <img src="<?php echo get_theme_file_uri('assets/img/screenshot.png'); ?>" alt="Imagem de slider <?php echo 'Wkode Padrão'; ?>" srcset="">
            </div>
          <?php
          }
        }
        ...
        if($slider_mobile){
          foreach($slider_mobile as $slide){
            if(!empty($slide['slider_image_mobile'])){
              ?>
              <div class="wkode-slider-slide">
                <img src="<?php echo $slide['slider_image_mobile']['sizes']['slider_mobile']; ?>" alt="Imagem de slider <?php echo $slide['slider_image_mobile']['title']; ?>" srcset="">
              </div>
              <?php
            }else{?>
              <div class="wkode-slider-slide" style="background-color: black;">
                <img src="<?php echo get_theme_file_uri('assets/img/screenshot-mobile.png'); ?>" alt="Imagem de slider <?php echo 'Wkode Padrão'; ?>" srcset="">
              </div>
            <?php
            }
          }
